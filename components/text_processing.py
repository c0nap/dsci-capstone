...
#**
# @class Chunk
# @brief Lightweight container for a span of story text.
# @details
...
class Chunk:
	...
	#*
	def __init__(self, text: str, book_id: int, chapter_number: int,
				 line_start: int, line_end: int,
				 story_id: int, story_percent: float, chapter_percent: float,
	...
	def char_count(self, prune_newlines: bool = False) -> int:
		...
		Args:
			prune_newlines: If True, count with '\n' removed.
	...
	def __repr__(self) -> str:
		return (f"Chunk(len={self.length}, book={self.book_id}, chapter={self.chapter_number}, "
