...
# ------------------------------------------------------------------------------
@pytest.mark.order(1)
@pytest.mark.dependency(name="rel_minimal", scope="session")
...
@pytest.mark.order(2)
@pytest.mark.dependency(name="docs_minimal", scope="session")
...
@pytest.mark.order(3)
@pytest.mark.dependency(name="graph_minimal", scope="session")
...
# ------------------------------------------------------------------------------
@pytest.mark.order(4)
@pytest.mark.dependency(name="rel_comprehensive", depends=["rel_minimal"], scope="session")
...
@pytest.mark.order(5)
@pytest.mark.dependency(name="docs_comprehensive", depends=["docs_minimal"], scope="session")
...
@pytest.mark.order(6)
@pytest.mark.dependency(name="graph_comprehensive", depends=["graph_minimal"], scope="session")
