...
CREATE (e1:DialogueEvent {name: "Knight speaks", speaker: "Knight", kg: "events"})
CREATE (e2:ActionEvent {name: "Knight is hired", subject: "Knight", kg: "events"})
CREATE (e3:SceneEvent {name: "Guide Master leaves room", subject: "Guide Master", kg: "events"})
CREATE (e4:DialogueEvent {name: "Guide Master speaks", speaker: "Guide Master", kg: "events"})
CREATE (e5:ActionEvent {name: "Wizard arrives", subject: "Wizard", kg: "events"})
CREATE (e6:DialogueEvent {name: "Wizard speaks", speaker: "Wizard", kg: "events"})
CREATE (e7:SceneEvent {name: "Knight enters hall", subject: "Knight", kg: "events"});

// Create event flow (DAG structure) - relations omit kg property intentionally
MERGE (e1:DialogueEvent {name: "Knight speaks", kg: "events"})
MERGE (e2:ActionEvent {name: "Knight is hired", kg: "events"})
MERGE (e3:SceneEvent {name: "Guide Master leaves room", kg: "events"})
MERGE (e4:DialogueEvent {name: "Guide Master speaks", kg: "events"})
MERGE (e5:ActionEvent {name: "Wizard arrives", kg: "events"})
MERGE (e6:DialogueEvent {name: "Wizard speaks", kg: "events"})
MERGE (e7:SceneEvent {name: "Knight enters hall", kg: "events"})
...
MERGE (e6:DialogueEvent {name: "Wizard speaks", kg: "events"})
SET e6.says = "I bring grave news", e6.audience = "Knight"
MERGE (e7:SceneEvent {name: "Knight enters hall", kg: "events"})
...
SET r3.snippet = "Guide Master addressed the crowd"
MERGE (e4)-[r4:followedBy {line: 75}]->(e5)
SET r4.snippet = "A flash of light interrupted"
MERGE (e5)-[r5:followedBy {line: 89}]->(e6)
SET r5.snippet = "Wizard turned to face Knight"
MERGE (e6)-[r6:followedBy {line: 102}]->(e7)
SET r6.snippet = "The following day, Knight";

// Create alternate path (branch in DAG) - Knight speaks can also lead directly to Wizard arrives
MERGE (e1:DialogueEvent {name: "Knight speaks", kg: "events"})
MERGE (e5:ActionEvent {name: "Wizard arrives", kg: "events"})
