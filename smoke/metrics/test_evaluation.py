...
def book_data():
    ...
    return {
        ...
        "excellent": (
            ...
            "were all locked. Alice discovered a little table made of solid glass with a tiny "
            "golden key on it. Behind a curtain Alice located a door about fifteen inches high. "
            "The key fit the door but Alice could not squeeze through. Alice ran back to the table and noticed a little "
            "bottle labeled DRINK ME. Alice ventured to taste it and felt a curious feeling. Alice was "
            ...
            "gloves and began fanning herself. Alice looked down and thought she had put on one of the "
            "White Rabbit's little gloves. Alice was shrinking small again. Alice ran to the table. Alice was "
            "about two feet high and shrinking rapidly. Alice dropped the fan hastily to avoid shrinking "
            "away altogether."
        ),
